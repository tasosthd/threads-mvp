...
if (missingConfig) {
  console.warn('Supabase is not configured yet. Open assets/js/supabase-config.js and add your real Project URL + anon public key. Do not use the service_role key.');
}
